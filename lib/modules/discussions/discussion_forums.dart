...
class _DiscussionForumsState extends State<DiscussionForums> {
  ...
  Widget buildPosts({required onLPressed,required onCPressed,lNum=0,cNum=0,required isColor}) {
    return Padding(
                  ...
                  children: [
                    IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: isColor==false?Colors.grey[500]:Colors.redAccent,
                        )),
                    Text(
                      '$lNum likes',
                      style: TextStyle(
